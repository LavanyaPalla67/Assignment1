...
<body>
 ...
 <!-- Header Ends here  -->
<br>
<h2 style="text-align:center; color:#fff">All Questions</h2>
 <div class="container">
  <div class="row">

  <?php  
include('db.php');
$result = $conn->query("SELECT * FROM question ORDER BY id DESC");
...
?>
    ...
    <div class="col-12">
      <a href="reply.php?id=<?php echo $row['id'] ?>" class="card-link">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-center"><?php echo $row['field_headline'] ?></h5>
            <p style="float:left">Category : <?php echo $row['category'] ?></p>

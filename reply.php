...
<body>
 <!--Header --><br>
 <h5 style="text-align:center; color:#fff">Reply</h5>
 <div class="container mt-5">
        ...
        <form action="replyinsert.php" method="post">
            <div class="form-group">
                <input type="text" name="questionid" value="<?php  $rd = $_GET['id']; echo $rd ?>" hidden>
                <input type="text" name="uniqueid" value="<?php echo $uniqueid ?>" hidden>
